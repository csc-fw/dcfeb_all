...
vlog -work work trg_mmcm_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax trg_mmcm_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.trg_mmcm_tb work.glbl
