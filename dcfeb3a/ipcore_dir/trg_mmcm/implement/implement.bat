...
xst -ifn xst.scr
move trg_mmcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\trg_mmcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc trg_mmcm_exdes.ucf trg_mmcm_exdes

echo 'Running map'
map -timing -pr b trg_mmcm_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm trg_mmcm_exdes -w routed.ncd routed.v
cd ..
