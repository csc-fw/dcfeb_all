...
xst -ifn xst.scr
move cmp_mmcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\cmp_mmcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc cmp_mmcm_exdes.ucf cmp_mmcm_exdes
...
netgen -ofmt verilog -sim -sdf_anno false -tm cmp_mmcm_exdes -w routed.ncd routed.v
cd ..
