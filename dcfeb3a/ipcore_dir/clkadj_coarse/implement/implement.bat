...
xst -ifn xst.scr
move clkadj_coarse_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkadj_coarse_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkadj_coarse_exdes.ucf clkadj_coarse_exdes
...
netgen -ofmt verilog -sim -sdf_anno false -tm clkadj_coarse_exdes -w routed.ncd routed.v
cd ..
