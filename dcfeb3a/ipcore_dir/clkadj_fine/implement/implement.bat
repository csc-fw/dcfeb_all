...
xst -ifn xst.scr
move clkadj_fine_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkadj_fine_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkadj_fine_exdes.ucf clkadj_fine_exdes
...
netgen -ofmt verilog -sim -sdf_anno false -tm clkadj_fine_exdes -w routed.ncd routed.v
cd ..
