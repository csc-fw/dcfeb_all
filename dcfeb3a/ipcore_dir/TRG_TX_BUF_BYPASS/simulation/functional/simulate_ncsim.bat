...
mkdir work
REM MGT Wrapper
ncvlog -work work   ..\..\..\trg_tx_buf_bypass_gtx.v
ncvlog -work work   ..\..\..\trg_tx_buf_bypass.v
...
ncvlog -work work  ..\..\example_design\trg_tx_buf_bypass_tx_sync.v
...
ncvlog -work work  ..\..\example_design\trg_tx_buf_bypass_top.v
