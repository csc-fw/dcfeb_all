...
xst -ifn xst.scr
move clkadj_med_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkadj_med_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkadj_med_exdes.ucf clkadj_med_exdes
...
netgen -ofmt verilog -sim -sdf_anno false -tm clkadj_med_exdes -w routed.ncd routed.v
cd ..
