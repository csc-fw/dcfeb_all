...
xst -ifn xst.scr
move samp_dyn_phs_mmcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\samp_dyn_phs_mmcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc samp_dyn_phs_mmcm_exdes.ucf samp_dyn_phs_mmcm_exdes

echo 'Running map'
map -timing -pr b samp_dyn_phs_mmcm_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm samp_dyn_phs_mmcm_exdes -w routed.ncd routed.v
cd ..
