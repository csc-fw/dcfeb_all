...
xst -ifn xst.scr
move adc_frame_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\adc_frame_clk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc adc_frame_clk_exdes.ucf adc_frame_clk_exdes
...
netgen -ofmt verilog -sim -sdf_anno false -tm adc_frame_clk_exdes -w routed.ncd routed.v
cd ..
